...
public class AdvertiseEntity {
	...
	public AdvertiseEntity(String title, Double price, String category, String description, 
	...
	public AdvertiseEntity(Integer id, String title, Double price, String category, String description, 
			String userName, Date createdDate, Date modifiedDate, String status, String postedBy) {
		super();
		this.id = id;
		this.title = title;
